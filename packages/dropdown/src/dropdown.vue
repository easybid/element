<script>
  ...
  import ElButton from 'eb-element/packages/button';
  import ElButtonGroup from 'eb-element/packages/button-group';
  import { generateId } from 'eb-element/src/utils/util';
