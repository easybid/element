import Vue from 'vue';
import { hasClass, addClass, removeClass } from 'eb-element/src/utils/dom';
...
export default {
              ...
              >
                {
                  columns.map((column, cellIndex) => (<th
                    ...
                    <div class={ ['cell', column.filteredValue && column.filteredValue.length > 0 ? 'highlight' : '', column.labelClassName] }>
                      ...
                      {
                        column.sortable && !column.filterable ? (<span
                          class="caret-wrapper"
                          ...
                          <svg t="1610873400618" class="sort-caret descending" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="3983"><path d="M739.555556 682.666667l-227.555556 227.555555-227.555556-227.555555h170.666667V170.666667h113.777778v512z" p-id="3984"></path></svg>
                          <svg t="1610873423815" class="sort-caret ascending" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4123"><path d="M568.888889 341.333333v512H455.111111V341.333333H284.444444l227.555556-227.555555 227.555556 227.555555z" p-id="4124"></path></svg>
                        </span>) : ''
                      }
                      {
  ...
  methods: {
    ...
    handleFilterClick(event, column) {
      ...
      cell = cell.querySelector('.cell') || (hasClass(cell, 'cell') ? cell : cell.parentNode);
